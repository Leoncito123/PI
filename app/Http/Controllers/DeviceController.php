...
class DeviceController extends Controller
{
  ...
  public function create(Request $request)
  {
    ...
    return redirect()->route('admin.devices')->with('success', 'Su tarjeta ha sido creada exitosamente');
  }
  ...
  public function edit(Request $request, $id)
  {
    ...
    return redirect()->route('admin.devices')->with('success', 'Sus cambios han sido implementados exitosamente');
  }

  public function destroy($id)
  {
    Device::destroy($id);
    return redirect()->route('admin.devices')->with('success', 'Se ha eliminado exitosamente su registro');
  }
}
