    ...
    <div class="container mx-auto px-4 h-screen flex flex-col items-center justify-start pt-6">
        ...
        <form id="ask" class="bg-gray-800 rounded-lg p-8 w-full max-w-3xl mb-6">
            ...
            <div class="mb-4">
                ...
                <input
                    class="border border-gray-600 appearance-none rounded w-full py-2 px-3 text-gray-900 leading-tight focus:outline-none focus:shadow-outline"
                    id="question" name="question" type="text" placeholder="Ask Gemini">
        ...
        $('#ask').submit(function(event) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    let divQuestion =
                        `<div class="bg-gray-800 text-white rounded p-4 mb-4"><h4 class="font-bold">Question: ${data.question}</h4></div>`;
                    let divAnswer =
                        `<div class="bg-gray-800 text-white rounded p-4 mb-4"><h5 class="font-bold">Answer</h5><textarea class="w-full h-32 p-2 border border-gray-600 rounded bg-gray-900 text-white" readonly>${data.answer}</textarea></div>`;
