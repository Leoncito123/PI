<x-layout2>
    ...
    <div class="flex items-center justify-end mb-4">
        <a href="{{ route('admin.create.device') }}"
        ...
        <table id="search-table">
            <thead>
                <tr>
                    ...
                    <th><span class="flex items-center">Planta</span></th>
            ...
            <tbody>
                ...
                @foreach ($devices as $device)
                    <tr>
                        <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $device->name }}</td>
                        <td>{{ $device->ubications->name }}</td>
                        <td>{{ $device->ubications->sector }}</td>
                        <td>
                            <a href="{{ route('admin.edit.device', $device->id) }}">
                        ...
                        <td>
                            <button type="submit" onclick="eliminarElemento({{ $device->id }})"
