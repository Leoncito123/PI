        ...
        <table id="search-table">
            ...
            <tbody>
                ...
                @foreach ($ubications as $ubication)
                    <tr>
                        <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $ubication->name }}
                        </td>
                        ...
                        <td>
                            <button
                                onclick="showMap({{ $ubication->latitude }}, {{ $ubication->longitude }}, '{{ $ubication->name }}')"
                        ...
                        <td>
                            <button onclick="eliminarElemento({{ $ubication->id }})"
            ...
            function eliminarElemento(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        fetch('/admin/delete/ubication/' + id, {
                                method: 'DELETE',
                                headers: {
