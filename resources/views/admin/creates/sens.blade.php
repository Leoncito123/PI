<x-layout2>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var defaultLat = {{ $ubications->first()->latitude }};
            var defaultLng = {{ $ubications->first()->longitude }};
            ...
            // Establecer las coordenadas por defecto de la ubicación seleccionada
            var selectedOption = document.getElementById('ubications').options[document.getElementById('ubications')
                .selectedIndex];
            var initialLat = selectedOption.getAttribute('data-latitude');
            var initialLng = selectedOption.getAttribute('data-longitude');
            if (initialLat && initialLng) {
                var initialLatLng = [parseFloat(initialLat), parseFloat(initialLng)];
