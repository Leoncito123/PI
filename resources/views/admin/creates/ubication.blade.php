<x-layout2>
    ...
    <div class="justify-center">
        <form class="max-w-sm mx-auto" action="{{ route('admin.creates.ubications') }}" enctype="multipart/form-data"
            method="POST">
            @csrf
            @method('POST')
            <div class="mb-5">
            ...
            <div class="mb-5">
                <label for="identifier" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre del
                    sector</label>
            ...
            <div class="mb-5">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="map">Seleccione su
                    ubicación</label>
            </div>
