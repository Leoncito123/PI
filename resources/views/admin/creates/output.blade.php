<x-layout2>
    ...
    <div class="justify-center">
        <form class="max-w-sm mx-auto" action="{{ route('admin.creates.outputs') }}" method="POST">
            ...
            <label for="ubications" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Seleccione la
                tarjeta del motor</label>
            <select id="ubications" name="dev_id"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option value="">Selecciona una tarjeta para el motor</option>
