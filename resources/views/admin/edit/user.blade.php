<x-layout2>
    ...
    <div class="justify-center">
        <form class="max-w-sm mx-auto" action="{{ route('admin.edits.user', $user->id) }}" method="POST">
            ...
            <button type="submit"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Editar usuario</button>
        </form>
    </div>
</x-layout2>
