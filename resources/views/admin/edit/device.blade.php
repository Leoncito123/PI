<x-layout2>
    ...
    <div class="justify-center">
        <form class="max-w-sm mx-auto" action="{{ route('admin.edits.device', $device->id) }}" method="POST">
            @csrf
            @method('POST')
            @if ($errors->any())
                <div class="mb-4">
            ...
            <div class="mb-5">
                ...
                <input type="text" id="name" name="name"
                    ...
                    placeholder="name@flowbite.com" required value="{{ $device->name }}" />
            </div>
            <div class="mb-5">
                ...
                <select id="ubications" name="ubication_id"
                    ...
                    @foreach ($ubications as $ubication)
                        <option value="{{ $ubication->id }}" @if ($ubication->id == $device->ubication_id) selected @endif>
